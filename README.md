...
Работа четвертого спринта Яндекс.Практикума Клементьевой Галины.
...
Работа представляет собой одностраничный сайт с добавлением различных элементов: карточек, изображений, всплывающего окна.
